 ...
 */
class Chamado extends \Vostre\CentralBundle\Entity\Chamado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'titulo', 'descricao', 'cliente', 'usuarioResponsavel', '' . "\0" . 'Vostre\\CentralBundle\\Entity\\Chamado' . "\0" . 'situacao', 'dataCadastro', 'usuarioCadastro', 'produto');
        }
    ...
    public function setUsuarioResponsavel(\Vostre\CentralBundle\Entity\Usuario $usuarioResponsavel = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUsuarioResponsavel', array($usuarioResponsavel));

        return parent::setUsuarioResponsavel($usuarioResponsavel);
    }
    ...
    public function getUsuarioResponsavel()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUsuarioResponsavel', array());

        return parent::getUsuarioResponsavel();
    }
