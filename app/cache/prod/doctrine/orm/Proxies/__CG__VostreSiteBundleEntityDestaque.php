 ...
 */
class Destaque extends \Vostre\SiteBundle\Entity\Destaque implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Destaque' . "\0" . 'id', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Destaque' . "\0" . 'titulo', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Destaque' . "\0" . 'descricao', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Destaque' . "\0" . 'site', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Destaque' . "\0" . 'imagem', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Destaque' . "\0" . 'file', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Destaque' . "\0" . 'temp', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Destaque' . "\0" . 'carrossel', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Destaque' . "\0" . 'ordem', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Destaque' . "\0" . 'situacao', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Destaque' . "\0" . 'dataCadastro', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Destaque' . "\0" . 'ultimaAlteracao', 'usuarioCadastro', 'usuarioUltimaAlteracao', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Destaque' . "\0" . 'locale');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Destaque $proxy) {
    ...
    public function setCarrossel($carrossel)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCarrossel', array($carrossel));

        return parent::setCarrossel($carrossel);
    }
    ...
    public function getCarrossel()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCarrossel', array());

        return parent::getCarrossel();
    }
