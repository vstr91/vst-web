 ...
 */
class Produto extends \Vostre\CentralBundle\Entity\Produto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nome', 'descricao', '' . "\0" . 'Vostre\\CentralBundle\\Entity\\Produto' . "\0" . 'situacao', 'dataCadastro', 'ultimaAlteracao', 'usuarioCadastro', 'usuarioUltimaAlteracao');
        }
