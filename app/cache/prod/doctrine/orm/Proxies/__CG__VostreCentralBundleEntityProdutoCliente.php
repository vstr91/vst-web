 ...
 */
class ProdutoCliente extends \Vostre\CentralBundle\Entity\ProdutoCliente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'produto', 'cliente', '' . "\0" . 'Vostre\\CentralBundle\\Entity\\ProdutoCliente' . "\0" . 'situacao', 'dataCadastro', 'usuarioCadastro');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProdutoCliente $proxy) {
