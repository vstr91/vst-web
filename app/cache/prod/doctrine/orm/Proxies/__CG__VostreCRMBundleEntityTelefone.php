 ...
 */
class Telefone extends \Vostre\CRMBundle\Entity\Telefone implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Vostre\\CRMBundle\\Entity\\Telefone' . "\0" . 'id', '' . "\0" . 'Vostre\\CRMBundle\\Entity\\Telefone' . "\0" . 'ddd', '' . "\0" . 'Vostre\\CRMBundle\\Entity\\Telefone' . "\0" . 'numero', '' . "\0" . 'Vostre\\CRMBundle\\Entity\\Telefone' . "\0" . 'tipo', '' . "\0" . 'Vostre\\CRMBundle\\Entity\\Telefone' . "\0" . 'situacao', '' . "\0" . 'Vostre\\CRMBundle\\Entity\\Telefone' . "\0" . 'cliente');
        }
