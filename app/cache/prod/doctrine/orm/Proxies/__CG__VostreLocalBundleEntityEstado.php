 ...
 */
class Estado extends \Vostre\LocalBundle\Entity\Estado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Vostre\\LocalBundle\\Entity\\Estado' . "\0" . 'id', '' . "\0" . 'Vostre\\LocalBundle\\Entity\\Estado' . "\0" . 'nome', '' . "\0" . 'Vostre\\LocalBundle\\Entity\\Estado' . "\0" . 'sigla', 'status', 'pais', 'dataCriacao', 'ultimaAlteracao');
        }
