 ...
 */
class ParadaItinerario extends \Circular\SiteBundle\Entity\ParadaItinerario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Circular\\SiteBundle\\Entity\\ParadaItinerario' . "\0" . 'id', 'ordem', 'parada', 'itinerario', 'status', 'destaque', 'dataCriacao', 'ultimaAlteracao');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ParadaItinerario $proxy) {
    ...
    public function setParada(\Circular\SiteBundle\Entity\Parada $parada = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setParada', array($parada));
    ...
    public function getParada()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getParada', array());
