 ...
 */
class Portfolio extends \Vostre\SiteBundle\Entity\Portfolio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Portfolio' . "\0" . 'id', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Portfolio' . "\0" . 'titulo', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Portfolio' . "\0" . 'descricao', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Portfolio' . "\0" . 'site', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Portfolio' . "\0" . 'imagem', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Portfolio' . "\0" . 'file', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Portfolio' . "\0" . 'temp', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Portfolio' . "\0" . 'cliente', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Portfolio' . "\0" . 'situacao', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Portfolio' . "\0" . 'dataCadastro', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Portfolio' . "\0" . 'ultimaAlteracao', 'usuarioCadastro', 'usuarioUltimaAlteracao', '' . "\0" . 'Vostre\\SiteBundle\\Entity\\Portfolio' . "\0" . 'locale');
        }
