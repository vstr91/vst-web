 ...
 */
class Empresa extends \Circular\SiteBundle\Entity\Empresa implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Circular\\SiteBundle\\Entity\\Empresa' . "\0" . 'id', '' . "\0" . 'Circular\\SiteBundle\\Entity\\Empresa' . "\0" . 'razaoSocial', '' . "\0" . 'Circular\\SiteBundle\\Entity\\Empresa' . "\0" . 'fantasia', '' . "\0" . 'Circular\\SiteBundle\\Entity\\Empresa' . "\0" . 'cnpj', '' . "\0" . 'Circular\\SiteBundle\\Entity\\Empresa' . "\0" . 'telefone', '' . "\0" . 'Circular\\SiteBundle\\Entity\\Empresa' . "\0" . 'site', '' . "\0" . 'Circular\\SiteBundle\\Entity\\Empresa' . "\0" . 'rua', '' . "\0" . 'Circular\\SiteBundle\\Entity\\Empresa' . "\0" . 'numero', '' . "\0" . 'Circular\\SiteBundle\\Entity\\Empresa' . "\0" . 'bairro', 'status', 'dataCriacao', 'ultimaAlteracao');
        }
