...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (preg_match('#^circular\\.vostre\\.dev\\.br$#si', $host, $hostMatches)) {
            // pt_BR__RG__circular_site
            if (rtrim($pathinfo, '/') === '') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'pt_BR__RG__circular_site');
                }
            ...
            if (rtrim($pathinfo, '/') === '/en') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'en__RG__circular_site');
                }
