...
";
    ...
    <div class=\"row\">
        ...
        echo "\">
                ";
        // line 23
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock((isset($context["formBairro"]) ? $context["formBairro"] : null), 'widget');
        echo "
    ...
    <div class=\"row\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["bairros"]) ? $context["bairros"] : null));
