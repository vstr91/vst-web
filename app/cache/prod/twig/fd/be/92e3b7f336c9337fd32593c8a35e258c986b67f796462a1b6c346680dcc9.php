...
class __TwigTemplate_fdbe92e3b7f336c9337fd32593c8a35e258c986b67f796462a1b6c346680dcc9 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
      ...
      action=\"";
        // line 2
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("circular_site_admin_parada_cadastrar", array("id_parada" => $this->getAttribute((isset($context["parada"]) ? $context["parada"] : null), "id", array()))), "html", null, true);
        echo "\" 
      method=\"POST\" ";
        // line 3
