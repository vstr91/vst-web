...
";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["itensMenu"]) ? $context["itensMenu"] : null));
        ...
        echo "                    <p class=\"navbar-text navbar-right v-bandeiras visible-sm visible-md visible-lg\">
                        <a href=\"";
        // line 37
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "attributes", array()), "get", array(0 => "_route"), "method"), twig_array_merge($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "attributes", array()), "get", array(0 => "_route_params"), "method"), array("_locale" => "pt_BR"))), "html", null, true);
        echo "\">
                            <img src=\"";
        // line 38
