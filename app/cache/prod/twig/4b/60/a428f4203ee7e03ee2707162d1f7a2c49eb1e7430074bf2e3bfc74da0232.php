    ...
    ";
        ...
        <div class=\"col-md-4\">
            <img class=\"v-imagem-servico\" src=\"";
                // line 6
                echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl(((isset($context["caminho"]) ? $context["caminho"] : null) . (($this->getAttribute($context["projeto"], "imagem", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($context["projeto"], "imagem", array()), "sem-foto.png")) : ("sem-foto.png")))), "html", null, true);
                echo "\">
                <h3>";
                // line 7
