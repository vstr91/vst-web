...
/* CircularSiteBundle:Admin/Horario:indexHorario.html.twig */
class __TwigTemplate_679f5f97be0422b7d6a151ffe01b2d07018c550590cb1a0bd6ad6f35471b1677 extends Twig_Template
{
...
";
    ...
    <div class=\"row\">
        <div class=\"col-md-12\">
            <form name=\"form-horario\" id=\"form-horario\" method=\"POST\" 
                  action=\"";
        // line 22
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("circular_site_admin_horarios_cadastra", array("id_horario" =>  -1)), "html", null, true);
        echo "\">
                ";
        // line 23
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock((isset($context["formHorario"]) ? $context["formHorario"] : $this->getContext($context, "formHorario")), 'widget');
        echo "
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["horario"]) {
            ...
            echo "</td>
                            <td>
                                ";
            // line 46
            if (($this->getAttribute($context["horario"], "status", array()) == 0)) {
                // line 47
                echo "                                Ativo
                                ";
            } else {
    ...
    {
        return "CircularSiteBundle:Admin/Horario:indexHorario.html.twig";
    }
