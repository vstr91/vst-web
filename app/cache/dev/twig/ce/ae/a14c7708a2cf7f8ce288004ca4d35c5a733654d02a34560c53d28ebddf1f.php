...
/* VostreCentralBundle:Admin/Pais:indexPais.html.twig */
class __TwigTemplate_ceaea14c7708a2cf7f8ce288004ca4d35c5a733654d02a34560c53d28ebddf1f extends Twig_Template
{
...
";
    ...
    <div class=\"row\">
        <div class=\"col-md-12\">
            <h4 class=\"text-center\">Gerenciamento de Pa&iacute;ses</h4>
        </div>
    </div>
    <div class=\"row\">
        <div class=\"col-md-12\">
            <form name=\"form-pais\" id=\"form-pais\" method=\"POST\" 
                  action=\"";
        // line 22
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("vostre_site_admin_paises_cadastra", array("id_pais" =>  -1)), "html", null, true);
        echo "\">
                ";
        // line 23
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock((isset($context["formPais"]) ? $context["formPais"] : $this->getContext($context, "formPais")), 'widget');
        echo "
    ...
    <div class=\"row\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["pais"]) {
            ...
            echo "</td>
                            <td>";
            // line 44
            echo twig_escape_filter($this->env, $this->getAttribute($context["pais"], "nome", array()), "html", null, true);
            echo "</td>
                            <td>
                                ";
            // line 46
            if (($this->getAttribute($context["pais"], "status", array()) == 0)) {
                // line 47
                echo "                                Ativo
                                ";
            } else {
    ...
    {
        return "VostreCentralBundle:Admin/Pais:indexPais.html.twig";
    }
