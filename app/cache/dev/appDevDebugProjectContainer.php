...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'doctrine.dbal.circular_connection' => 'getDoctrine_Dbal_CircularConnectionService',
            'doctrine.dbal.connection_factory' => 'getDoctrine_Dbal_ConnectionFactoryService',
            'doctrine.dbal.logger' => 'getDoctrine_Dbal_LoggerService',
            'doctrine.dbal.logger.profiling.circular' => 'getDoctrine_Dbal_Logger_Profiling_CircularService',
            'doctrine.dbal.logger.profiling.vostre' => 'getDoctrine_Dbal_Logger_Profiling_VostreService',
            'doctrine.dbal.vostre_connection' => 'getDoctrine_Dbal_VostreConnectionService',
            ...
            'vostre.type.bairros' => 'getVostre_Type_BairrosService',
            'vostre.type.local' => 'getVostre_Type_LocalService',
        ...
        $this->aliases = array(
            'database_connection' => 'doctrine.dbal.vostre_connection',
    ...
    {
        return $this->services['doctrine'] = new \Doctrine\Bundle\DoctrineBundle\Registry($this, array('vostre' => 'doctrine.dbal.vostre_connection', 'circular' => 'doctrine.dbal.circular_connection'), array('default' => 'doctrine.orm.default_entity_manager'), 'vostre', 'default');
    }

    /**
     * Gets the 'doctrine.dbal.circular_connection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Dbal_CircularConnectionService()
    {
        $a = new \Doctrine\DBAL\Logging\LoggerChain();
        $a->addLogger($this->get('doctrine.dbal.logger'));
        $a->addLogger($this->get('doctrine.dbal.logger.profiling.circular'));
        ...
        return $this->services['doctrine.dbal.circular_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'vcircular', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    /**
     * Gets the 'doctrine.dbal.vostre_connection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\DBAL\Connection A Doctrine\DBAL\Connection instance.
     */
    protected function getDoctrine_Dbal_VostreConnectionService()
    {
        $a = new \Doctrine\DBAL\Logging\LoggerChain();
        $a->addLogger($this->get('doctrine.dbal.logger'));
        $a->addLogger($this->get('doctrine.dbal.logger.profiling.vostre'));
        ...
        return $this->services['doctrine.dbal.vostre_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'vostre_novo_dev', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\vendor\\gedmo\\doctrine-extensions\\lib\\Gedmo\\Translatable\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Vostre\\SiteBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Vostre\\CentralBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\Vostre\\LocalBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\Vostre\\CRMBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\Circular\\SiteBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Gedmo\\Translatable\\Entity');
        $c->addDriver($b, 'Vostre\\SiteBundle\\Entity');
        $c->addDriver($b, 'Vostre\\CentralBundle\\Entity');
        $c->addDriver($b, 'Vostre\\LocalBundle\\Entity');
        $c->addDriver($b, 'Vostre\\CRMBundle\\Entity');
        $c->addDriver($b, 'Circular\\SiteBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('gedmo_translatable' => 'Gedmo\\Translatable\\Entity', 'VostreSiteBundle' => 'Vostre\\SiteBundle\\Entity', 'VostreCentralBundle' => 'Vostre\\CentralBundle\\Entity', 'VostreLocalBundle' => 'Vostre\\LocalBundle\\Entity', 'VostreCRMBundle' => 'Vostre\\CRMBundle\\Entity', 'CircularSiteBundle' => 'Circular\\SiteBundle\\Entity'));
        ...
        $this->services['doctrine.orm.default_entity_manager'] = $instance = \Doctrine\ORM\EntityManager::create($this->get('doctrine.dbal.vostre_connection'), $d);
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_b9077dc1dfb30cd4d1bce65510007ccf3969eb68f9bcc23b47fbc6e88601d425');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Vostre\\CentralBundle\\Entity\\Usuario');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Vostre\\CentralBundle\\Entity\\Usuario');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Vostre\\CentralBundle\\Entity\\Usuario');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Vostre\\CentralBundle\\Entity\\Usuario');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Vostre\\CentralBundle\\Entity\\Usuario');
    }
    ...
    {
        return $this->services['jms_i18n_routing.loader'] = new \JMS\I18nRoutingBundle\Router\I18nLoader($this->get('jms_i18n_routing.route_exclusion_strategy'), new \JMS\I18nRoutingBundle\Router\DefaultPatternGenerationStrategy('prefix_except_default', $this->get('translator'), array(0 => 'pt_BR', 1 => 'en'), __DIR__, 'routes', 'pt_BR'));
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\swiftmailer-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\assetic-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'\\vendor\\doctrine\\doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\framework-extra-bundle\\Sensio\\Bundle\\FrameworkExtraBundle/Resources/config/serializer'), 'Vostre\\SiteBundle' => ($this->targetDirs[3].'\\src\\Vostre\\SiteBundle/Resources/config/serializer'), 'Vostre\\CentralBundle' => ($this->targetDirs[3].'\\src\\Vostre\\CentralBundle/Resources/config/serializer'), 'Vostre\\LocalBundle' => ($this->targetDirs[3].'\\src\\Vostre\\LocalBundle/Resources/config/serializer'), 'Vostre\\CRMBundle' => ($this->targetDirs[3].'\\src\\Vostre\\CRMBundle/Resources/config/serializer'), 'FOS\\UserBundle' => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\FixturesBundle' => ($this->targetDirs[3].'\\vendor\\doctrine\\doctrine-fixtures-bundle\\Doctrine\\Bundle\\FixturesBundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\rest-bundle\\FOS\\RestBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'\\vendor\\jms\\serializer-bundle\\JMS\\SerializerBundle/Resources/config/serializer'), 'Circular\\SiteBundle' => ($this->targetDirs[3].'\\src\\Circular\\SiteBundle/Resources/config/serializer'), 'Stof\\DoctrineExtensionsBundle' => ($this->targetDirs[3].'\\vendor\\stof\\doctrine-extensions-bundle/Resources/config/serializer'), 'JMS\\I18nRoutingBundle' => ($this->targetDirs[3].'\\vendor\\jms\\i18n-routing-bundle\\JMS\\I18nRoutingBundle/Resources/config/serializer'), 'JMS\\TranslationBundle' => ($this->targetDirs[3].'\\vendor\\jms\\translation-bundle\\JMS\\TranslationBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\generator-bundle\\Sensio\\Bundle\\GeneratorBundle/Resources/config/serializer')));
    ...
    protected function getProfilerService()
    {
        ...
        $d->addLogger('vostre', $this->get('doctrine.dbal.logger.profiling.vostre'));
        $d->addLogger('circular', $this->get('doctrine.dbal.logger.profiling.circular'));
    ...
    protected function getRouterService()
    {
        ...
        $instance->setDefaultLocale('pt_BR');
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/central-do-cliente'), 'security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/login$'), 'security.firewall.map.context.secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/demo/secured/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $g = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $d, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($d, 'vostre_site_central_cliente'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        ...
        $h->setOptions(array('default_target_path' => '/central-do-cliente/home', 'login_path' => '/central-do-cliente', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $i->setOptions(array('login_path' => '/central-do-cliente', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username_email')), 'main', $b, $c), 2 => $g, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $f, $this->get('security.authentication.session_strategy'), $d, 'main', $h, $i, array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, $this->get('form.csrf_provider')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '57c5ab0a359c7', $b, $f), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '/central-do-cliente', false), NULL, NULL, $b));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username_email')), 'secured_area', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'secured_area', $g, $h, array('check_path' => '_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '_demo_login', false), NULL, NULL, $b));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setPassword('almirjuniorglg91');
        $a->setAuthMode('login');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Vostre\\SiteBundle/Resources/translations\\messages.en.yml'), 'en', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Vostre\\SiteBundle/Resources/translations\\messages.pt_BR.yml'), 'pt_BR', 'messages');
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Circular\\SiteBundle/Resources/translations\\messages.en.yml'), 'en', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\Circular\\SiteBundle/Resources/translations\\messages.pt_BR.yml'), 'pt_BR', 'messages');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'bootstrap_3_layout.html.twig')), $a)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Vostre\\SiteBundle/Resources/views'), 'VostreSite');
        $instance->addPath(($this->targetDirs[3].'\\src\\Vostre\\CentralBundle/Resources/views'), 'VostreCentral');
        $instance->addPath(($this->targetDirs[3].'\\src\\Vostre\\LocalBundle/Resources/views'), 'VostreLocal');
        $instance->addPath(($this->targetDirs[3].'\\src\\Vostre\\CRMBundle/Resources/views'), 'VostreCRM');
        $instance->addPath(($this->targetDirs[2].'/Resources/FOSUserBundle/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Circular\\SiteBundle/Resources/views'), 'CircularSite');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('671ad10a550c5482a14f12f7c899be115');
    }
    ...
    /**
     * Gets the 'vostre.type.bairros' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Vostre\LocalBundle\Form\Type\BairroType A Vostre\LocalBundle\Form\Type\BairroType instance.
     */
    protected function getVostre_Type_BairrosService()
    {
        return $this->services['vostre.type.bairros'] = new \Vostre\LocalBundle\Form\Type\BairroType($this->get('doctrine'));
    }

    /**
     * Gets the 'vostre.type.local' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Vostre\LocalBundle\Form\Type\LocalType A Vostre\LocalBundle\Form\Type\LocalType instance.
     */
    protected function getVostre_Type_LocalService()
    {
        return $this->services['vostre.type.local'] = new \Vostre\LocalBundle\Form\Type\LocalType($this->get('doctrine'));
    }
    ...
    /**
     * Gets the 'doctrine.dbal.logger.profiling.circular' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrine_Dbal_Logger_Profiling_CircularService()
    {
        return $this->services['doctrine.dbal.logger.profiling.circular'] = new \Doctrine\DBAL\Logging\DebugStack();
    }

    /**
     * Gets the 'doctrine.dbal.logger.profiling.vostre' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return \Doctrine\DBAL\Logging\DebugStack A Doctrine\DBAL\Logging\DebugStack instance.
     */
    protected function getDoctrine_Dbal_Logger_Profiling_VostreService()
    {
        return $this->services['doctrine.dbal.logger.profiling.vostre'] = new \Doctrine\DBAL\Logging\DebugStack();
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/central-do-cliente/?$'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/central-do-cliente/home/?$'), array(0 => 'ROLE_ADMIN', 1 => 'ROLE_SUPER_ADMIN', 2 => 'ROLE_CLIENTE'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/central-do-cliente/home/'), array(0 => 'ROLE_ADMIN', 1 => 'ROLE_SUPER_ADMIN', 2 => 'ROLE_CLIENTE'), NULL);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN', 2 => 'ROLE_ALLOWED_TO_SWITCH'), 'ROLE_CLIENTE' => array(0 => 'ROLE_USER')));
    }
    ...
    protected function getStofDoctrineExtensions_Listener_TranslatableService()
    {
        ...
        $instance->setDefaultLocale('pt_BR');
        $instance->setTranslatableLocale('pt_BR');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'VostreCentralBundle' => 'Vostre\\CentralBundle\\VostreCentralBundle',
                'VostreLocalBundle' => 'Vostre\\LocalBundle\\VostreLocalBundle',
                'VostreCRMBundle' => 'Vostre\\CRMBundle\\VostreCRMBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'DoctrineFixturesBundle' => 'Doctrine\\Bundle\\FixturesBundle\\DoctrineFixturesBundle',
                'FOSRestBundle' => 'FOS\\RestBundle\\FOSRestBundle',
                'JMSSerializerBundle' => 'JMS\\SerializerBundle\\JMSSerializerBundle',
                'CircularSiteBundle' => 'Circular\\SiteBundle\\CircularSiteBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'vostre_novo_dev',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'gmail',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'almir.amjunior@gmail.com',
            'mailer_password' => 'almirjuniorglg91',
            'locale' => 'pt_BR',
            'secret' => '671ad10a550c5482a14f12f7c899be115',
            ...
            'kernel.secret' => '671ad10a550c5482a14f12f7c899be115',
            ...
            'swiftmailer.mailer.default.transport.smtp.password' => 'almirjuniorglg91',
            ...
            'doctrine.connections' => array(
                'vostre' => 'doctrine.dbal.vostre_connection',
                'circular' => 'doctrine.dbal.circular_connection',
            ),
            'doctrine.default_connection' => 'vostre',
            ...
            'fos_user.model.user.class' => 'Vostre\\CentralBundle\\Entity\\Usuario',
            ...
            'jms_i18n_routing.default_locale' => 'pt_BR',
