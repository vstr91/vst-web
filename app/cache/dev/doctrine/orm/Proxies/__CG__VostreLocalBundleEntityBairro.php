 ...
 */
class Bairro extends \Vostre\LocalBundle\Entity\Bairro implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Vostre\\LocalBundle\\Entity\\Bairro' . "\0" . 'id', '' . "\0" . 'Vostre\\LocalBundle\\Entity\\Bairro' . "\0" . 'nome', 'status', 'local', 'dataCriacao', 'ultimaAlteracao');
        }
