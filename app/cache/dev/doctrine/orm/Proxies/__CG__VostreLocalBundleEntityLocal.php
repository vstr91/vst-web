 ...
 */
class Local extends \Vostre\LocalBundle\Entity\Local implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Vostre\\LocalBundle\\Entity\\Local' . "\0" . 'id', '' . "\0" . 'Vostre\\LocalBundle\\Entity\\Local' . "\0" . 'nome', 'tipo', 'status', 'estado', 'cidade', 'dataCriacao', 'ultimaAlteracao');
        }
    ...
    public function isCidadeValida()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isCidadeValida', array());

        return parent::isCidadeValida();
    }
