 ...
 */
class TipoUsuario extends \Vostre\CentralBundle\Entity\TipoUsuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Vostre\\CentralBundle\\Entity\\TipoUsuario' . "\0" . 'id', '' . "\0" . 'Vostre\\CentralBundle\\Entity\\TipoUsuario' . "\0" . 'nome', '' . "\0" . 'Vostre\\CentralBundle\\Entity\\TipoUsuario' . "\0" . 'situacao');
        }
