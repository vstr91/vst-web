 ...
 * Destaque
 *
 * @ORM\Entity(repositoryClass="Vostre\SiteBundle\Entity\Repository\DestaqueRepository")
 * @ORM\Table(name="destaque")
 * @ORM\HasLifecycleCallbacks()
 */
class Destaque implements Translatable {
     ...
     * @var string
     *
     * @ORM\Column(name="carrossel", type="boolean")
     */
    private $carrossel;
     ...
     * Set carrossel
     *
     * @param boolean $carrossel
     * @return Destaque
     */
    public function setCarrossel($carrossel)
    {
     ...
     *
     * @param Usuario $usuarioUltimaAlteracao
     * @return Destaque
     */
