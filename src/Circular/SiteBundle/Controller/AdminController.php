...
class AdminController extends Controller {
    ...
    public function indexParadaAction()
    {
        ...
        $paradaType = new ParadaCompletaType();
    ...
    public function indexMensagemAction()
    {
        ...
        $mensagemType = new MensagemType();
        $formMensagem = $this->createForm($mensagemType);
        
        $mensagens = $em->getRepository('CircularSiteBundle:Mensagem')
                ->findAll();
        
        return $this->render('CircularSiteBundle:Admin:Mensagem/indexMensagem.html.twig', array(
            'usuario' => $user,
            'mensagens' => $mensagens,
            'formMensagem' => $formMensagem->createView()
        ));
    }
    
    public function indexSecaoItinerarioAction()
    {
        ...
        return $this->render('CircularSiteBundle:Admin:SecaoItinerario/indexSecaoItinerario.html.twig', array(
            'usuario' => $user,
            'itinerarios' => $itinerarios
        ));
    }
